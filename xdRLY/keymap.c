...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_BSLS,        KC_Z,           KC_X,           KC_C,           LT(3, KC_D),    KC_V,                                           KC_K,           LT(4, KC_H),    KC_COMMA,       KC_DOT,         KC_DQUO,        KC_SLASH,       
                                                    MT(MOD_LSFT, KC_BSPC),QK_REPEAT_KEY,                                          LT(1, KC_ENTER),MT(MOD_RCTL, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
  ...
  [5] = LAYOUT_voyager(
    ...
    QK_DYNAMIC_TAPPING_TERM_UP,RGB_HUI,        RGB_SAI,        RGB_SPI,        RGB_VAI,        HSV_0_255_255,                                  KC_NO,          KC_PSCR,        KC_BRIGHTNESS_UP,KC_AUDIO_VOL_UP,KC_F20,         KC_NO,          
    QK_DYNAMIC_TAPPING_TERM_PRINT,TOGGLE_LAYER_COLOR,RGB_SLD,        RGB_MODE_FORWARD,RGB_TOG,        HSV_74_255_255,                                 KC_NO,          KC_TRANSPARENT, KC_BRIGHTNESS_DOWN,KC_AUDIO_VOL_DOWN,KC_AUDIO_MUTE,  KC_NO,          
    QK_DYNAMIC_TAPPING_TERM_DOWN,RGB_HUD,        RGB_SAD,        RGB_SPD,        RGB_VAD,        HSV_169_255_255,                                KC_NO,          KC_MEDIA_PLAY_PAUSE,KC_MEDIA_STOP,  KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK,KC_NO,          
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [6] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
  ...
  [7] = LAYOUT_voyager(
    ...
    KC_SLASH,       KC_DQUO,        KC_DOT,         KC_COMMA,       KC_H,           KC_K,                                           KC_V,           KC_D,           KC_C,           KC_X,           KC_Z,           KC_BSLS,        
                                                    KC_SPACE,       KC_ENTER,                                       ST_MACRO_2,     KC_BSPC
  ),
  [8] = LAYOUT_voyager(
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_2:
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_LEFT))SS_DELAY(5)  SS_LCTL(SS_TAP(X_C))SS_DELAY(5)  SS_TAP(X_RIGHT)SS_DELAY(5)  SS_LCTL(SS_TAP(X_V)));
    }
    break;
